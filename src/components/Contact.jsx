      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Have questions about our dance classes? Ready to start your dance journey? Drop us a message!
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-purple-500/20">
              <h3 className="text-xl font-semibold text-purple-400 mb-2">Visit Us</h3>
            ...
            <div className="bg-white/5 backdrop-blur-sm p-6 rounded-2xl border border-purple-500/20">
              <h3 className="text-xl font-semibold text-purple-400 mb-2">Contact Info</h3>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  <Clock className="h-5 w-5 text-purple-400 flex-shrink-0" />
                  <p className="text-gray-400">Classes: Mon-Sat 4:00 PM - 9:00 PM</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {alert.show && (
            <div className={`mt-6 p-4 rounded-lg ${
              alert.type === 'success' ? 'bg-green-500/20 text-green-200' : 'bg-red-500/20 text-red-200'
            }`}>
              {alert.text}
            </div>
          )}
